    ...
    <div className="project-root">
      ...
      <div className="project-container">
        <div className="project-text-div">
          ...
          <p className="page-p-intro">
            Responsible for overseeing the team throughout the entire
            development process, actively engaged in functionality design and
            implementation, UX/UI design, and the execution of QA testing.
          </p>
          <p className="page-p-intro">
            Implemented socket.io server for multiplayer modes
          </p>
          <p className="page-p-intro">
            Implemented core functions including saving game progress, game
            stats, multi-session, and pause/resume
          </p>
        </div>
        <img
          src={wordle}
          alt="wordle thumbnail"
      ...
      <div className="project-container">
        <div className="project-text-div">
          ...
          <p className="page-p-intro">
            Record daily monetary transactions, decreased 80% of recording
            errors, reduced 50% time for end-of-day settlement and
            record-keeping.
          </p>
          <p className="page-p-intro">
            Membership record & search system to maintain 200+ member
            information, which reduced the time of checking customer information
            to nearly zero.
          </p>
          <p className="page-p-intro">
            Integrated garbage collection feature to automatically remove
            expired records.
          </p>
          <p className="page-p-intro">
      ...
      <div className="project-container">
        <div className="project-text-div">
          ...
          <p className="page-p-intro">
            A Next.js-based frontend project published on [Vercel] that
            showcases browsing, managing data, and Figma design.
          </p>
          <p className="page-p-intro">
            Displays an interactive infinite scrolling list of users, allows the
            user to apply various filters based on the properties of the users
            in the list.
          </p>
          <p className="page-p-intro">
